...
class PCloudProjection:
    ...
    def project_pc(self, ref_theta = 0.0, ref_phi = 0.0, ref_anchor_point_xyz = None):
        ...
        self.load_pc_file()
        if self.top_view:
            self.xyz = utilities.rotate_to_top_view(self.xyz, self.anchor_point_xyz[0], self.anchor_point_xyz[1], self.anchor_point_xyz[2])
        ...
        return self.h_fov[0], self.v_fov[0], self.anchor_point_xyz
